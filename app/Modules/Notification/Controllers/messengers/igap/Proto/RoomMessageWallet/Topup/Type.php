...
namespace Proto\RoomMessageWallet\Topup;

use UnexpectedValueException;

/**
 * Protobuf type <code>proto.RoomMessageWallet.Topup.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Proto\RoomMessageWallet_Topup_Type::class);
