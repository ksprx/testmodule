...
class ConnectionSymmetricKeyResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Proto\ConnectionSymmetricKeyResponse\Status::class);
        $this->status = $var;
