...
class ClientSearchRoomHistory extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $offset_message_id = 0;
    /**
     * Generated from protobuf field <code>uint64 offset_document_id = 6;</code>
     */
    protected $offset_document_id = 0;
     ...
     *     @type int|string $offset_document_id
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Proto\ClientSearchRoomHistory\Filter::class);
        $this->filter = $var;
     ...
     * @return int|string
     */
    public function getOffsetDocumentId()
    {
        return $this->offset_document_id;
    }
     ...
     * @return $this
     */
    public function setOffsetDocumentId($var)
    {
        GPBUtil::checkUint64($var);
        $this->offset_document_id = $var;
