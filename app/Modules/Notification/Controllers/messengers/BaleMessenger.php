...
use App\Modules\Notification\Controllers\messengers\bale\api;
use App\Modules\User\Models\NotificationChannel;

class BaleMessenger extends MessengerTempelete
{
    protected const  API_KEY = "1432417392:PgNFm8jfhpgVcvQ3NXZukpdq5woaUD5GQl6tLfcR";
    ...
    public static function getInstance(): BaleMessenger
    {
    ...
    public function webhook(): array
    {
        ...
        if (!$channel) {
            ...
            self::getApp()->sendMessage([
                "text" => "برای استفاده از کالا بازار در پیام رسان بله ، ابتدا حساب خود را با استفاده از دکمه زیر به کالا بازار متصل کنید.",
